...
class NJInputController: NSObject, NJHIDManagerDelegate {
    static let simulatingEventsDefaultsKey = "simulatingEvents"
    ...
    var simulatingEvents: Bool = false {
        didSet {
            ...
            UserDefaults.standard.set(simulatingEvents, forKey: Self.simulatingEventsDefaultsKey)
    ...
    func load() {
        ...
        let persistedSimulatingEvents = UserDefaults.standard.object(forKey: Self.simulatingEventsDefaultsKey) as? Bool
        ...
        if let persistedSimulatingEvents {
            simulatingEvents = persistedSimulatingEvents
        }
    }
